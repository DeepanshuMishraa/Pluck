...
const Navbar = () => {
  ...
  return (
    <div className="md:w-[26.5rem] bg-inherit h-16 flex relative md:left-[29rem] md:p-2 md:mt-1 rounded-full md:text-white md:space-x-4 p-2 border-2 shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] mt-4 w-[22.5rem] left-[4rem]  ">
